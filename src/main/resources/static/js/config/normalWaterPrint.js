function getData() {
    return {
        ...
        "data": {
            ...
            "legalMan": "xxxxxxxxxxxxxxx",
            "contactPerson": "xxxxxxxxxxxxxxx",
            "phone": "123456789123",
            "address": "xxxxxxxxxxxxxxx",
            "postcode": "123456",
            "bankAccount": "xxxxxxxxxxxxxxx",
            "supplierSeller": "supplierSeller",
            "legalManSeller": "xxxxxxxxxxxxxxx",
            "addressSeller": "xxxxxxxxxxxxxxx",
            "contactPersonSeller": "xxxxxxxxxxxxxxx",
            "phoneSeller": "654321",
            "postcodeSeller": "123456",
            "bankNameSeller": "xxxxxxxxxxxxxxx",
            "bankAccountSeller": "12345678901234560"
        }
    }
}
...
function getXml() {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: contextPath + "/config/getXml.json?fileName=normalWaterPrint",
        data: null,
...
function genPdf() {
    var data = getSubmitData();
    data['isPage'] = '0';
    document.forms["pdfForm"].printConfigJSON.value = JSON.stringify(data);
